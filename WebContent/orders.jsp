...
<%@page import="com.oracle.xianshop.model.javabean.Orders"%>
...
<script type="text/javascript">
			function deleteOrder(n){
				...
				if(window.confirm('确认删除这个订单吗')){
					location.href='order/delete?orderId='+n.id;
				}
			}
			function deleteOrderItem(n){
				if(window.confirm('确认删除这个商品吗')){
					location.href='order/delete1?orderId='+n.id;
				}	
			}
	</script>
</head>
					...
					<div class="personArea">
						...
						<div class="MeorderArea ">
							...
							<div style="border: 1px solid blue;padding-top: 20px">
									...
									收货人:<%=o.getName() %>&nbsp;&nbsp;&nbsp;
									收货地址:<%=o.getAddress()%>&nbsp;&nbsp;&nbsp;
									<a class="delet" id="<%=o.getOrderid()%>" onclick="deleteOrder(this)">取消订单</a>
									</h1>
								...
								<div class="merchandiseList">
									<div class="ListArea">
										...
										<ul class="ListTable">
											...
											<li class="five">
												<a class="delet" id=<%=o.getOrderid()+"&goodsId="+String.valueOf(g.getGoodsid()) %>  onclick="deleteOrderItem(this)">删除该商品</a>
											</li>
